...
export function loginPage(options) {
  ...
  const body = html`
    <div class="card card-narrow" ${'' /* centered by margin below */}>
      <h1>Sign in</h1>
      <p class="tagline">Optional — anonymous pastes work without an account.</p>
      ...
      <p class="card-foot">No account yet? <a href="/register">Register</a> — it takes ten seconds.</p>
    </div>
  `;
  return layout({
...
export function registerPage(options) {
  ...
  const body = html`
    <div class="card card-narrow">
      ...
      <p class="tagline">Bigger pastes (10 MB), your own paste list, edit and delete.</p>
      ${alertBox(options.errors)}
